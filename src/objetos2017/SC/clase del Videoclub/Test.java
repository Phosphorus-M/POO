...
public class Test {
	public static void main(String[] args) {
		Pelicula Terminator = new Pelicula("Terminator", 1984, "Ciencia ficcion", "James Cameron");
		Pelicula Piloto = new Pelicula("Donde esta el piloto", 1980, "Catastrofe", "David Zucker, Jim Abrahams");
		Pelicula Future = new Pelicula("Back to the Future", 1985 , "Ciencia ficcion", "Robert Zemeckis");
